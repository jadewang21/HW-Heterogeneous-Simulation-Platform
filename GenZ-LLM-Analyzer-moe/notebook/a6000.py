...
if __name__ == '__main__':
    ...
    parser.add_argument("--system_eff", type=float, default=0.28, help="System efficiency")
    
    # 并行配置参数
    parser.add_argument("--tp_nodes", type=int, default=4, help="Tensor parallel nodes (推荐4个用于70B模型)")
    ...
    parser.add_argument("--summary_dir", type=str,
                        default="/home/wang/sim/bench/phy-test/direct_execute/a6000-lab/tp4-7b",
